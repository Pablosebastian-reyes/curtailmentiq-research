...
\quad unbounded (submitted version) & 90.1\,(0.43) & 544 & 4.2 & 962 & $\infty$ \\
\quad $\alpha_{\min}=0.005$ & 89.8\,(0.43) & 550 & 0.0 & 956 & 956 \\
\quad $\alpha_{\min}=0.01$ & 89.8\,(0.43) & 536 & 0.0 & 942 & 942 \\
\quad $\alpha_{\min}=0.02$ & 89.7\,(0.43) & 525 & 0.0 & 932 & 932 \\
\addlinespace
\multicolumn{6}{l}{\emph{Transport+ACI ($\gamma{=}0.05$)}} \\
\quad unbounded (submitted version) & 90.1\,(0.43) & 596 & 5.9 & 1030 & $\infty$ \\
\quad $\alpha_{\min}=0.005$ & 89.6\,(0.43) & 641 & 0.0 & 1059 & 1059 \\
\quad $\alpha_{\min}=0.01$ & 89.6\,(0.43) & 598 & 0.0 & 1017 & 1017 \\
\quad $\alpha_{\min}=0.02$ & 89.5\,(0.43) & 559 & 0.0 & 981 & 981 \\
\bottomrule
\end{tabular}
\end{table*}
