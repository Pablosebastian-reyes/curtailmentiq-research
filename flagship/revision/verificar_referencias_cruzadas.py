...
MAPA_SEMANTICO = [
    ...
    ('sec:novedad',    r'Section~([\d.]+) closes by noting that the combination does not survive its ablation'),
    ('eq:shrink',      r'Now given as equation~\((\d+)\) of the manuscript'),
    ...
    ('tab:sens_hiper', r'reported on the test set, in Table~([\d]+) of Section'),
    ('sec:frontera',   r'reported on the test set, in Table~\d+ of Section~([\d.]+)'),
    ('tab:sens_hiper', r'chronology sensitivity and, in Table~([\d]+),'),
