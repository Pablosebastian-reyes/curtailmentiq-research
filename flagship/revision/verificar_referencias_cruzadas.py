...
MAPA_SEMANTICO = [
    ...
    ('tab:frontera',   r'Section~5\.7 and Table~([\d.]+), the boundary sensitivity'),
    ('tab:panel',      r'Section~5\.6 and Table~([\d.]+)\s*,?\s*conditional coverage'),
    ('sec:ablaciones', r'Section~([\d.]+) is a new subsection\. Table~6 gives the marginal'),
    ...
    ('sec:base',       r'Section~([\d.]+) describes the three base models'),
    ...
    ('tab:diagnostico',r'Table~([\d.]+) \(all fifteen cells and the fitted relationship\)'),
