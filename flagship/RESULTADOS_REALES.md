...
El diagnóstico condicional que aísla la dispersión (PIT condicional sobre los positivos, Phi de (log y menos mu) sobre sigma), comparando el train out-of-fold (sin quiebre) contra el OOS (con cambio de regimen), fija el porqué:
